...
import NavButton from '../../molecules/navigation-button/NavigationButton';
import { Nav, NavigationButtons, TimerContent, TimerContentWrapper } from './styles';
...
import { WorkoutTimer } from '../../molecules/workout-timer';
