...
import { IModalButton, Modal } from '../../atoms/modals/modal';
import { exerciseSetsStore, trainingStore } from '../../../stores';
import { ExerciseDetailsName, ExerciseDetailsTable, ExerciseDetailsTableHeader } from './styles'
import { ExerciseSet, IExerciseSet } from './components/exercise-set';
